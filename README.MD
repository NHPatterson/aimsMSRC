...
* Examine the tutorial [scripts](https://github.com/NHPatterson/aimsMSRC/tree/master/scripts) and [R markdown](https://github.com/NHPatterson/aimsMSRC/tree/master/markdown) files for workflow examples
